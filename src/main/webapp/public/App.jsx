    ...
    render() {
        return (
            <div>
                ...
                <VehicleTable deleteVehicle={this.deleteVehicle} rentVehicle={this.rentVehicle}
                              releaseVehicle={this.releaseVehicle} toggleGridRenderFalse={this.toggleGridRenderFalse}
                              vehicles={this.state.vehicles} customers={this.state.customers}
                              shouldGridRender={this.state.shouldGridRender}/>
            </div>
        );
    }
}
...
class VehicleTable extends React.Component {
    ...
    render() {
        var vehicles = this.props.vehicles.map(vehicle =>
            <Vehicle key={vehicle._links.self.href} vehicle={vehicle} customers={this.props.customers}
                     deleteVehicle={this.props.deleteVehicle} rentVehicle={this.props.rentVehicle}
                     releaseVehicle={this.props.releaseVehicle} shouldGridRender={this.props.shouldGridRender}
                     toggleGridRenderFalse={this.props.toggleGridRenderFalse}/>
        );
...
class Vehicle extends React.Component {
    ...
    setupRentedBy() {
        ...
        return (
            <select className="custom-select my-1 mr-sm-2" id="customerSelect" name="customer"
            ...
            <div className="panel panel-default">
                ...
                <div className="panel-body">
                    <form className="form-inline">
                        ...
                        <div className="col-md-2">
                            <input type="text" placeholder="Make" className="form-control" name="make"
                                   onChange={this.handleChange}/>
                        </div>
                        <div className="col-md-2">
                            <input type="text" placeholder="Model" className="form-control" name="model"
                                   onChange={this.handleChange}/>
                        </div>

                        <div className="col-md-2">
                            <input type="text" placeholder="Number of Wheels" className="form-control"
                                   name="numberOfWheels" onChange={this.handleChange}/>
                        </div>
                        <div className="col-md-2">
                            <input type="text" placeholder="Number of Passengers" className="form-control"
                                   name="numberOfPassengers" onChange={this.handleChange}/>
                        </div>
